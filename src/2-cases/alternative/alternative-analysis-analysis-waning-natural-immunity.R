...
# sensitivity analysis that accounts for waning natural immunity and interaction between prior natural infection and subsequent vaccination
#Author: Sophia Tan
###################################################################################################
...
source("src/2-cases/alternative/alternative-model-analysis-functions-waning-natural-immunity.R")
...
parameters <- readRDS("Direct Effects Analysis/final results/simulated-parameters.RDS")
cases <- read_csv("/mnt/projects/covid_partners/ucsf_lo/Direct Effects Analysis/Data/ca_case_data.csv")
ca_cases_inf <- read.csv("/mnt/projects/covid_partners/ucsf_lo/Direct Effects Analysis/Data/ca_case_data_infection_cutoffs.csv")
...
saveRDS(res_12_18, "results/alternative/waning-imm/res_12_18_sim_nat_wane.RDS")
saveRDS(res_18_50, "results/alternative/waning-imm/res_18_50_sim_nat_wane.RDS")
saveRDS(res_50_65, "results/alternative/waning-imm/res_50_65_sim_nat_wane.RDS")
saveRDS(res_65, "results/alternative/waning-imm/res_65_sim_nat_wane.RDS")
