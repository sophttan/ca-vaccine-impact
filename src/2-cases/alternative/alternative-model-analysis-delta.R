...
source("src/2-cases/alternative/alternative-model-analysis-functions.R")
...
for (i in 1:nrow(parameters)) {
  ...
  for (group in 1:4) {
    ca <- calculate_vacc(group, ca, delta = T)
  }
...
saveRDS(res_12_18, "results/alternative/delta/res_12_18_sim_delta.RDS")
saveRDS(res_18_50, "results/alternative/delta/res_18_50_sim_delta.RDS")
saveRDS(res_50_65, "results/alternative/delta/res_50_65_sim_delta.RDS")
saveRDS(res_65, "results/alternative/delta/res_65_sim_delta.RDS")
