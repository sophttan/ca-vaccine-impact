...
saveRDS(res_12_18, "Direct Effects Analysis/final results/res_12_18_sim.RDS")
saveRDS(res_18_50, "Direct Effects Analysis/final results/res_18_50_sim.RDS")
saveRDS(res_50_65, "Direct Effects Analysis/final results/res_50_65_sim.RDS")
saveRDS(res_65, "Direct Effects Analysis/final results/res_65_sim.RDS")
