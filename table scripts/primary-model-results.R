...
vacc_coverage <- vacc_avg[c(5,1:4)]
...
reduction_data <-rbind(reduction_total, reduction_12_18, reduction_18_50, reduction_50_65, reduction_65)/vacc_coverage*100
reduction_data[reduction_data > 100] <- 100
reduction <- format_res(round(reduction_data))
reduction_unadj <- format_res(round(rbind(reduction_total, reduction_12_18, reduction_18_50, reduction_50_65, reduction_65)))
...
primary_results <- data.frame("Age group" = c("Total (12+)", "12-17", "18-49", "50-64", "65+"), 
                                 ...
                                 "Adjusted reduction in cases in % (95% PI)" = reduction,
                                 "Reduction in cases in % (95% PI)" = reduction_unadj)
