...
res_12_18 <- readRDS("Direct Effects Analysis/final results/res_12_18_sim_nat_wane.RDS")%>% filter(weeks_since_Jan2020 >= 48)
res_18_50 <- readRDS("Direct Effects Analysis/final results/res_18_50_sim_nat_wane.RDS")%>% filter(weeks_since_Jan2020 >= 48)
res_50_65 <- readRDS("Direct Effects Analysis/final results/res_50_65_sim_nat_wane.RDS")%>% filter(weeks_since_Jan2020 >= 48)
res_65 <- readRDS("Direct Effects Analysis/final results/res_65_sim_nat_wane.RDS")%>% filter(weeks_since_Jan2020 >= 48)
...
vacc_avg <- apply(vacc_spread, 2, mean)[3:8]
...
names(tbl) <- c("Age group", 
                ...
                "Adjusted")
tbl %>% write_csv("Direct Effects Analysis/final tables/alternative-model-tbl-waning-natural-immunity.csv")
