...
#Results for sensitivity analysis of alternative model - waning natural immunity
#Author: Sophia Tan
###################################################################################################
...
hosp <- readRDS("results/hospitalizations and deaths/hosp_results_alternative_model_waning_imm.RDS")
death <- readRDS("results/hospitalizations and deaths/death_results_alternative_model_waning_imm.RDS")
...
write.csv(tbl, "tables/alternative-model-waning-imm-results-etable6.csv", row.names = F)
